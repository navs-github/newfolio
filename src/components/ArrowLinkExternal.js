    ...
    return (
        <a href={props.link} rel="noopener noreferrer" target="_blank">
            <span className="group flex flex-row items-center space-x-2.5">
                <span className="text-base xl:text-xl tracking-wide font-work font-medium uppercase group-hover:text-yellow-base transition-colors duration-200">{props.text}</span>
