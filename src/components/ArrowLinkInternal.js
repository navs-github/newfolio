    ...
    return (
        <Link to={props.to}>
            <span className="group flex flex-row items-center space-x-2.5">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-base group-hover:text-yellow-accent transition-colors duration-200" viewBox="0 0 20 20" fill="currentColor">
