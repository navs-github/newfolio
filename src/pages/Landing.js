        ...
        <Layout>
            ...
            <section ref={contactRef} className="mt-64 2xl:mt-72 pb-24 flex flex-col items-start">
                ...
                <div className={"opacity-0 " + (inViewContact ? 'animate-fadein' : 'animate-none')}>
                    <p className="mt-8 xl:mt-12 leading-[180%]">I’m on the hunt for a full-time gig at an agency or startup. I fill roles like UX designer, front-end developer, and anything in between.</p>
                    <ArrowLinkSet>
                        <li className="">
